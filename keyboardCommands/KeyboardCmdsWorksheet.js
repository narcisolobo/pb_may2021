...
// Hold alt then left click here ^ (inside the quotation)
   ...
   console.log("Hello, my name is ")// Hold alt then left click here ^ (inside the quotation)
...
console.log("The first prime number is: ")
console.log("The first prime number is: ")
console.log("The first prime number is: ")
console.log("The first prime number is: ")
...
console.log("Did 'More copying' appear 3 times after line 89?");
...
console.log("Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best!")
